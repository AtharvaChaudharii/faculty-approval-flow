...
import { ArrowLeft, FileText, Check, X, User, Clock, CheckCircle2, XCircle, Sparkles, Download, Pen } from 'lucide-react';
    ...
    <div className="max-w-6xl animate-fade-in">
      ...
      {actionTaken && (
        <div className={cn(
          ...
          <p className="text-sm font-medium">
            {actionTaken === 'approved' ? 'Document approved successfully.' : 'Document has been rejected.'}
          </p>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-6">
          <div className="institutional-card aspect-[3/4] flex flex-col items-center justify-center bg-muted/30">
        ...
        <div className="lg:col-span-3">
          {canAct && (
            <div className="institutional-card p-5 space-y-4">
              ...
              <p className="text-xs text-muted-foreground">
                This document is awaiting your review. Please approve or reject.
              </p>
              <div className="space-y-2">
                <Button className="w-full" onClick={() => setActionTaken('approved')}>
          ...
          {/* Document info */}
          <div className="institutional-card p-5 mt-4">
      ...
      <Dialog open={showRejectModal} onOpenChange={setShowRejectModal}>
        <DialogContent>
          ...
          <textarea
            ...
            rows={3}
            placeholder="Optional: Add comments for the sender..."
