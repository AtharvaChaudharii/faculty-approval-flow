...
const users: User[] = [
  currentUser,
  { id: '2', name: 'Prof. Rajesh Kumar', email: 'rajesh@college.edu', role: 'faculty', department: 'Computer Science' },
  { id: '3', name: 'Dr. Anita Desai', email: 'anita@college.edu', role: 'assistant_professor', department: 'Computer Science' },
  { id: '4', name: 'Dr. Sunil Mehta', email: 'sunil@college.edu', role: 'principal', department: 'Administration' },
  { id: '5', name: 'Prof. Kavita Rao', email: 'kavita@college.edu', role: 'director', department: 'Administration' },
  { id: '6', name: 'Dr. Amit Patel', email: 'amit@college.edu', role: 'faculty', department: 'Mathematics' },
];
